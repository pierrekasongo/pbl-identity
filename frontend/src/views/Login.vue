     ...
     <v-container grid-list-xl text-xs-center>
       <v-layout row wrap>
         <v-flex xs4 offset-xs4>
           <v-card primary darken-1 white--text font-weight-bold elevation-24 style="padding: 20px; border: 1px; border-radius: 50px;">
             <v-card-text>
              ...
              <br>
               <v-btn @click="login" color="primary darken-2" large>Valider</v-btn>
             </v-card-text>
           </v-card>
         </v-flex>
       </v-layout>
